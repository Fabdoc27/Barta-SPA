            ...
            <div class="pb-12 border-b border-gray-900/10">
                <div class="pb-12 mt-10 border-b border-gray-900/10">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <x-input-field id="name" wire:model="name" :hasError="$errors->has('name')" value="{{ old('name', $user->name) }}" />
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <x-input-field id="username" wire:model="username" :hasError="$errors->has('username')" value="{{ old('username', $user->username) }}" />
                        ...
                        <div class="col-span-full">
                            <div class="col-span-full">
                                ...
                                <x-input-field type="password" wire:model="password" id="password" :hasError="$errors->has('password')" />
                        ...
                        <div class="col-span-full">
                            ...
                            <x-input-field type="password" wire:model="password_confirmation" id="confirm_password" :hasError="$errors->has('password_confirmation')" />
                ...
                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="col-span-full">
                        ...
                        <x-input-textarea id="bio" wire:model="bio" rows="3" :hasError="$errors->has('bio')">{{ $user->bio }}</x-input-textarea>
